...
void
initialize(Stack* stack, int max)
{
    int i;
...
void
push(Stack* stack, Element element, Bool user, Bool verbose)
{
    if (is_full(*stack)) {
...
void
print_stack(Stack stack, Bool verbose)
{
    int i;
...
int
find_first_non_null(Stack stack, Bool verbose)
{
    int i;
...
void
reverse_stack(Stack* stack, Bool verbose)
{
